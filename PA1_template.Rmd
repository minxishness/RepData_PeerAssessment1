...
Median total number of steps per day was: `r medsteps`

Mean total number of steps per day was: `r meansteps`
...
The average calculated by ignoring the missing values was `r meansteps`, vs. `r meansteps1`, calculated by replacing the missing values by the period average.

The median calculated by ignoring the missing values was `r medsteps`, vs. `r medsteps1`, calculated by replacing the missing values by the period average.
