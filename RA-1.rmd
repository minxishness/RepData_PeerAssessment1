...
cat("Median total number of steps per day was: ",medsteps)
cat("Mean total number of steps per day was: ",medsteps)
```
...
cat("The median calculated by ignoring the missing values was ", medsteps, " vs. ", medsteps1, "calculated by replacing the missing values by the period average")
cat("The average calculated by ignoring the missing values was ", meansteps, " vs. ", meansteps1, "calculated by replacing the missing values by the period average")
```
